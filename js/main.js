...
// copy start
document.querySelectorAll(".salin-rekening").forEach((button) => {
  button.onclick = () => {
    const rek = button.closest(".card").querySelector(".norek");
    rek.select();
...
// waktu start
const countDownDate = new Date("2027-05-19T00:00:00+07:00").getTime();
